...
- [x] Unificar línea de tiempo: definir si el jugador está en Presente o Año 20.000 (NeoPlaga = expansión/epílogo)
...
- [x] Cheat Sheet / Referencia rápida (stats, fórmulas, posturas en 1 página)
...
- [x] Delimitar Moscas vs Sanguijuelas narrativamente (evitar solapamiento temático)

- [ ] Tooltips en stats: Sensilios [Percepción], Ganglios [Reflejos], etc.

- [x] Definir identidad/caricatura única de cada taxón (1 frase + nicho narrativo + monopolio mecánico por clan)
...
## 📅 Sesión 7b — 2 Junio 2026

### Novela de la Avispa — "Los 38 Segundos de Cera"
- [x] Novela completa: 9 capítulos, POV Sargento Cera (primera persona)
- [x] Simultánea a "La Colmena Silenciosa" — mismos eventos, POV desde adentro del sacrificio
- [x] Consistencia verificada: "40 segundos" (dice al grupo) vs 38 reales (redondea por profesionalismo)
- [x] `novela-avispa.html` — página wiki completa con countdown visual del Cap 8
- [x] Sidebar de las 8 novelas existentes actualizado con link a la Avispa
- [x] `novelas.html` indexada con entrada "✅ COMPLETADA"
- [x] Link cruzado con novela de la Vinchuca (novelas hermanas)

### Ollama — Dataset expandido + Reentrenamiento
- [x] `dataset_novela_avispa.jsonl` — 15 pares sobre la novela de Cera
- [x] `dataset_image_prompts.jsonl` — 24 prompts de arte (todos los taxones + escenas)
- [x] `dataset_sesion7.jsonl` — 28 pares (identidad taxones, atavismos, línea temporal, estilo arte)
- [x] `unir_datasets.js` — script unificador de 13 datasets JSONL
- [x] `dataset_completo.jsonl` — 534 pares únicos (era 423, +111 nuevos)
- [x] Reentrenamiento QLoRA exitoso: loss 1.3 → 0.18, accuracy 95%, 635 steps
- [x] `Modelfile.plaga-narrator` actualizado con rol de director artístico + image prompts
- [x] `ENTRENAR_NOCHE.bat` v2 — con tiempos estimados visibles en cada paso

### Pipeline de Generación de Imágenes (Stable Diffusion local)
- [x] `diffusers` instalado (SDXL via Python, GPU RTX 3060 Ti)
- [x] `generar_sprite.py` — generador directo con prompt en inglés
- [x] `generar_con_ollama.py` — español → Ollama → prompt → SD → imagen
- [x] `GENERAR_SPRITES.bat` — menú interactivo con progreso visible
- [x] `GENERAR_NOVELA_AVISPA.bat` — 9 ilustraciones de momentos clave
- [x] `ESTILO_ARTE.md` — guía de estilo completa (Mignola + Hollow Knight + Darkest Dungeon)
- [x] 17 taxones con prompts individuales detallados (rasgos de insecto preservados)
- [x] Iteraciones v1→v5 de prompts refinando estilo comic/ink
- [x] Negative prompts agresivos para evitar render 3D realista

### Wiki — Nuevas páginas
- [x] `identidad-taxones.html` — 10 taxones con frase, nicho, monopolio mecánico, atavismos
- [x] `cheatsheet.html` — stats, fórmulas, Danza, Antenas, Esencia en 1 página
- [x] `linea-temporal.html` — cronología unificada + "el juego ES Año 20.000" + Moscas vs Sanguijuelas
- [x] `dashboard.html` actualizado: 97%, 248 tareas, 61 páginas, sesión 7

### Correcciones
- [x] Fix encoding masivo: 7 archivos corregidos (double-UTF8) con `fix_encoding.py`
- [x] Línea temporal unificada: el juego es Año 20.000, NeoPlaga ya no es un nombre separado
- [x] Delimitación Moscas vs Sanguijuelas (tabla comparativa completa)

### Diseño — Decisiones tomadas
- [x] Sistema de atavismos rediseñado: 1 exclusivo + 2 compartidos (como VTM Disciplinas)
- [x] 6 atavismos compartidos definidos + quién los tiene
- [x] 10 atavismos exclusivos definidos (monopolio por taxón)
- [x] Estilo artístico definido: comic ink/Mignola, antropomorfos vestidos, rasgos de insecto preservados
- [x] Alas integradas como vestuario (capas, gabardinas, vestidos, hombreras)
- [x] Máscaras/yelmos por taxón definidos
- [x] Propuesta: armas exclusivas por taxón (estilo Guild Wars 2)
- [x] Propuesta: paleta híbrida (color base=taxón, acento=facción)
- [x] Propuesta: alas de avispa como propulsores retráctiles (lore)

### Pendientes próxima sesión
- [ ] Evaluar imágenes v4/v5 y seleccionar las mejores para la wiki
- [ ] Entrenar LoRA de estilo con las imágenes buenas (consistencia visual)
- [ ] Generar ilustraciones de novela de la Avispa (9 escenas)
